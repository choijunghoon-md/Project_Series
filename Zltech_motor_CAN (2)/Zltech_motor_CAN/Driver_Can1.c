...
uint8 Enable[8]={0x2B, 0x40, 0x60, 0x00, 0x00, 0x00, 0x00, 0x00};
uint8 Speed[8]={0x23, 0xFF, 0x60, 0x00, 0x00, 0x00, 0x00, 0x00};
uint8 mode[8]={0x2F, 0x60, 0x60, 0x00, 0x03, 0x00, 0x00, 0x00};
uint8 pu[8] = {0x23, 0x7A, 0x60, 0x00, 0x80, 0x0C, 0x00, 0x00};
uint8 msp[8]={0x23, 0x81, 0x60, 0x00, 0x3C, 0x00, 0x00, 0x00};
...
void Time(int timee){
    int a[8]={0x23, 0x83, 0x60, 0x00, 0x00, 0x00, 0x00, 0x00};
    time.ti=timee;
    CanRxMsg MES;
    int i=0;
    MES.ID=0x601;
...
void START(void){
    int a[8]={0x2B, 0x40, 0x60, 0x00, 0x4F, 0x00, 0x00, 0x00};
    CanRxMsg MES;
    int i=0;
    MES.ID=0x601;
    MES.IDE=0;
